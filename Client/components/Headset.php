<!-- headset -->
<section id="headset" class="p-0 m-0 flex justify-center items-center py-10">
    <div class="container mx-auto">
        <div class="py-10 flex flex-col items-center gap-5">
            <div class="grid grid-cols-1 text-center md:px-0 px-4" data-aos="fade-in" data-aos-duration="1000">
                <h1 class="text-5xl text-black font-bold py-5">GAMING HEADSET</h1>
                <h1 class="text-lg text-black">With our lethal line-up of advanced gaming headsets, experience clear, powerful audio that builds incredible soundscapes for a new level of immersion, and gain the competitive edge with next-gen surround sound. </h1>
            </div>
            <br>
            <div class="w-full grid md:grid-cols-3 col-1 place-items-center xl:gap-52 gap-10">
                <?php
                $connect = new mysqli('localhost', 'root', '', 'my--store');
                $result = $connect->query("SELECT * FROM `product` WHERE category = 'Headset'");
